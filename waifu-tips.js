    ...
    async function chat() {
        ...
        await axios.get(baseUrl + "/chat?question=美国")
            .then(response => {
                ...
                const text = `这是我找到的信息：${response.data['answer']}`;
                showMessage(text, 4000, 9);
